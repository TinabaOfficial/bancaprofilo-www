...
- Formattare i sorgenti in modo leggibile anche senza formatter automatici: evitare linee eccessivamente lunghe, distribuire markup, attributi, proprietà CSS, oggetti e array su più righe quando migliora la lettura umana.
- Non introdurre Prettier o altri formatter come dipendenze obbligatorie per risolvere la leggibilità; privilegiare una formattazione manuale coerente con il contesto Astro e verificare il diff dopo ogni intervento.
