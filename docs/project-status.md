...
- Asset visuali locali selezionati e verificati, loghi locali e quattro documenti PDF selezionati dal mirror.
...
- La voce di navigazione “Soluzioni” porta a `/soluzioni/`, un riepilogo dell’offerta per conto e carta, pagamenti, condivisione, risparmio, investimenti e business. `/carta/` resta una pagina prodotto specifica.
...
- Il build corrente genera 47 pagine HTML, inclusi `/news/`, `/soluzioni/`, `/brand-guidelines/` e `/sitemap.xml`.
...
Le attività pre-produzione sono raccolte in `docs/release-checklist.md`. Le domande editoriali e legal sono raccolte in `docs/editorial-legal-questions.md`; la matrice delle fonti è in `docs/content-inventory.md`.
